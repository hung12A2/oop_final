...
public class LoginRestAssured extends BaseRestAssuredClass{
  ...
  //API LOGIN NHAP KHONG DUNG EMAIL PASSWORD - MA CODE 1002
    ...
    public static ResponseUnitTest UnitTest003() {
    	...
    	LoginRequestModel requestBody = RequestApiLogin.UnitTest003.requestBody;
    	ResponseUnitTest rut = new ResponseUnitTest(); 
    	ObjectMapper mapper = new ObjectMapper();
		...
		try {
	        ...
	        Constant.ACCESS_TOKEN_1 = "Bearer " + resObj.getData().getAccessToken();
    ...
    public static ResponseUnitTest UnitTest004() {
    	...
    	LoginRequestModel requestBody = RequestApiLogin.UnitTest004.requestBody;
    	ResponseUnitTest rut = new ResponseUnitTest(); 
    	ObjectMapper mapper = new ObjectMapper();
		...
		try {
	        ...
	        Constant.ACCESS_TOKEN_2 = "Bearer " + resObj.getData().getAccessToken();
